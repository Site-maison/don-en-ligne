 ...
 * @since       1.6
 */
class SoutiensControllerSoutienpaimts extends JControllerLegacy
{
	/**
	 * @var		string	The context for persistent state.
	 * @since   1.6
	 */
	protected $context = 'com_soutiens.soutienpaimts';
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Soutienpaimts', $prefix = 'SoutiensModel', $config = array())
	{
