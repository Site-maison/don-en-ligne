 ...
 * @since       1.5
 */
class SoutiensModelDownload extends JModelForm
{
	protected $_context = 'com_soutiens.soutienpaimts';
	...
	{
		// Get the form.
		$form = $this->loadForm('com_soutiens.download', 'download', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
			return false;
		}
	...
	protected function loadFormData()
	{
		...
		$this->preprocessData('com_soutiens.download', $data);
